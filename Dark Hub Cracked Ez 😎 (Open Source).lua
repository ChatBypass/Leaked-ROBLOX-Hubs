...
--Some Unknown Game Shit (Darkhub)///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
local lib = loadstring(game:HttpGet("https://zypher.wtf/Libraries/DH-UI-Lib.lua"))()
local main = lib:CreateMain()

local Main = main:CreateWindow("Functions")
...
Main:Toggle('No Ragdoll',function(state)
Client.Toggles.NoRagdoll = state
end)
Main:Toggle('No Fall Damage',function(state)
Client.Toggles.NoFallDamage = state
end)
...
old = require(game.ReplicatedStorage.GunScripts.CreateShot).CreateShot
require(game.ReplicatedStorage.GunScripts.CreateShot).CreateShot = function(...)
local args = {...}
if Client.Toggles.SilentAim and tostring(args[1]['BulletOwner']) == game.Players.LocalPlayer.Name and getclosestplr() ~= nil then
    args[1]['cframe'] = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position,getclosestplr().HumanoidRootPart.Position)
end
return old(unpack(args))
end

local old2 = require(game.ReplicatedStorage.SharedModules.Ragdoll).EnableRagdoll
require(game.ReplicatedStorage.SharedModules.Ragdoll).EnableRagdoll = function(...)
local args = {...}
...
local args = {...}
if getnamecallmethod() == "FireServer" then
    if tostring(self) == 'ChangeCharacter' and args[1] == 'Damage' and Client.Toggles.NoFallDamage == true then
        if args[2] ~= 10000 then
            args[2] = 0    
        end
    end
    if tostring(self) == 'ChangeCharacter' and args[1] == 'Ragdoll' and Client.Toggles.NoRagdoll == true then
        return    
    end
end
return namecall(self,unpack(args))
...
--Phantom Forces (mikehales was here :troll:) //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mikehales7/Darkhub-UI-Library/main/.lua", true))()
local lib2 = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mikehales7/Darkhub-UI-Library/main/.lua", true))()
function Info(Text)
